...
def pause():
    ...
    while True:
        ...
        draw_text("Pausa", menu_font, (255, 255, 255), screen, 480, 240)
        ...
        draw_rect(screen, (50, 90, 168), continue_button_rect, button_font, "Continuar")
        ...
        draw_rect(screen, (50, 90, 168), menu_button_rect, button_font, "Menú principal")
        ...
        if continue_button_rect.collidepoint((mx, my)):
            ...
            draw_rect(screen, (65, 116, 217), aux_rect, button_font, "Continuar", "big")
            if click:
